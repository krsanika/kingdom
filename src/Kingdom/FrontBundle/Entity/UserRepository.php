    ...
    public function loadUserByUsername($username) {
        ...
        try{
            ...
            throw new UsernameNotFoundException(
                    sprintf('Unable to find an active admin KingdomFrontBundle:User object identified by "%s".', $name),
                    null, 0, $e);
        }
...
//        return $this->findOneBy(array('name' => $username));
    ...
    //            ->leftJoin("KingdomAdminBundle:Qna", "q", "WITH", "u.id = q.userId")
                ->orderBy("u.".$order, $asc)
    //            ->groupBy("q.userId")
        ...
        $qb2 = $this->getEntityManager()->getRepository("KingdomAdminBundle:Qna")
