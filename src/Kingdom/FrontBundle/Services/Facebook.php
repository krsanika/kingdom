<?php
namespace Kingdom\FrontBundle\Services;
...
public static $config = array(
        'appId'  => '779799958726036',
        'secret' => 'ac520131750ea91c9f2ae2922460fd4a'        
);

public static $param = array(
        'scope' => 'read_stream, friends_likes, email, user_birthday',
        'redirect_uri' => 'http://54.65.156.106/picker/web/app.php/login/facebook'
);
