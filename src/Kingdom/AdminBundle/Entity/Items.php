 ...
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="Kingdom\AdminBundle\Entity\ItemsRepository")
 */
class Items
{
    ...
    /**    
     * @ORM\OneToMany(targetEntity="Kingdom\FrontBundle\Entity\Cart", mappedBy="itemId", cascade={"persist"})
     */
    protected $carts;
