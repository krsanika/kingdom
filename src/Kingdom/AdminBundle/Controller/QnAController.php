...
class QnAController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $qnas = $this->getDoctrine()->getRepository("KingdomAdminBundle:Qna")->findForAdmin($userId, $start, self::DEFAULT_PAGE);        
        $pager = 0;
        if($userId == 0){
            $pager = $this->getDoctrine()->getRepository("KingdomAdminBundle:Qna")->maxPage(self::DEFAULT_PAGE);            
        }
    ...
    public function addAction($userId, $orderedId){
        ...
        $user =$this->getDoctrine()->getRepository("KingdomFrontBundle:User")->find($userId);
        $order =$this->getDoctrine()->getRepository("KingdomAdminBundle:Ordered")->find($orderedId);
